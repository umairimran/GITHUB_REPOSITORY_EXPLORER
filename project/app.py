...
app=FastAPI()
init_db()
client = genai.Client(api_key="AIzaSyCRT2H1V_wipL1ice_N5yTWI44qT_q4-7g")
def generate_response(query, history, collection_name):
    ...
    if search_results:
        ...
        prompt = (
            ...
            "Be really good at coding and explaining you are the best expert in world ."
...
async def get_all_documents():
    try:
        ...
        # Convert Collection objects to a list of dictionaries
        document_names = [{"name": collection.name} for collection in collections]
        return {"status": "success", "collections": document_names}
    except Exception as e:
