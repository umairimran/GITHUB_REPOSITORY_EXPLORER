...
class VectorDB:
    ...
    def first_rank_using_embeddings(self, query, collection_name=None):
        ...
        lock = threading.Lock()  # Initialize lock for thread-safety
        ...
        def process_collection(each_collection):
            ...
            try:
                ...
                if collection_name and collection_name != each_collection:
                    return

                print(f"Collection {each_collection} queried")
                collection = self.create_collection(each_collection)
